...
mod test {
    ...
    fn test_model(model: Model<Cuda<f32, i32>>) -> (i64, i64) {
        let db_file = Path::new("/home/y0sif/college/gp/rough_hook/rough_guard/data_in_sql_lite/test_unnorm.db");
        let dataset = SqliteDataset::from_db_file(db_file, "test").unwrap();
