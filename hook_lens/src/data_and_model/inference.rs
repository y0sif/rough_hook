...
use burn::{
    module::Module,
    prelude::Backend,
    record::{CompactRecorder, FullPrecisionSettings, HalfPrecisionSettings, NamedMpkFileRecorder, Recorder},
    ...
    B::FloatElem: ndarray_linalg::Scalar + ndarray_linalg::Lapack,
{
    fn forward(&self, x: Tensor<B, 4>) -> Tensor<B, 2> {
        match self {
            ...
            //     model
            // )=>model.forward(x),
            ModelEnum::ResNet(model) => model.forward(x),
    ...
    B::FloatElem: ndarray_linalg::Scalar + ndarray_linalg::Lapack,
{
    match id {
        ...
        30 => ModelEnum::ResNet(
            ResNet::resnet152_pretrained(weights::ResNet152::ImageNet1kV2, device)
                .unwrap()
                .with_classes(13),
        ),
